...
const checkArray = function (array) {
	...
	console.log("Somma numeri maggiori di 5: " + contatore);
};
...
const shoppingCartTotal = function (oggetto) {
	let totale = 0;

	for (let i = 0; i < oggetto.length; i++) {
		totale += oggetto[i].price * oggetto[i].quantity;
	}
...
const addToShoppingCart = function (shoppingCartTotal, price, name, id, quantita) {
	shoppingCart;
};
